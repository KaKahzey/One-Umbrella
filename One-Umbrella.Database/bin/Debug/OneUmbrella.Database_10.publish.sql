...
ALTER TABLE [dbo].[ReservedTable]
    ADD CONSTRAINT [FK_RESERVEDTABLE_RESERVATION] FOREIGN KEY ([RESERVATION_ID]) REFERENCES [dbo].[Reservation] ([RESERVATION_ID]);
...
GO
ALTER TABLE [dbo].[ReservedTable]
    ADD CONSTRAINT [FK_RESERVEDTABLE_TABLE] FOREIGN KEY ([TABLE_ID]) REFERENCES [dbo].[TableEntity] ([TABLE_ID]);
...
VALUES (1, 15, 20, 15, 21, 6, 'rectangular')

INSERT INTO dbo.TableEntity(GRID_ID, ROW_INDEX, COLUMN_INDEX, END_ROW_INDEX, END_COLUMN_INDEX, SEAT_CAPABILITY, TABLE_Type)
VALUES (1, 10, 40, 10, 40, 2, 'square')

INSERT INTO dbo.TableEntity(GRID_ID, ROW_INDEX, COLUMN_INDEX, END_ROW_INDEX, END_COLUMN_INDEX, SEAT_CAPABILITY, TABLE_Type)
VALUES (3, 72, 60, 72, 60, 8, 'cicle')
