...
ALTER TABLE [dbo].[Customer]
    ADD CONSTRAINT [FK_CUSTOMER_USER] FOREIGN KEY ([HUMAN_ID]) REFERENCES [dbo].[Human] ([HUMAN_ID]) ON DELETE CASCADE;
...
ALTER TABLE [dbo].[Owner]
    ADD CONSTRAINT [FK_OWNER_USER] FOREIGN KEY ([HUMAN_ID]) REFERENCES [dbo].[Human] ([HUMAN_ID]) ON DELETE CASCADE;
